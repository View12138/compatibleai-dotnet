...
public partial class StreamingChatCompletionUpdate
{
    ...
    private ChatMessageContent _reasoningContentUpdate;
    ...
    /// <remarks>
    ///     Each streaming update contains only a small portion of tokens. To reconstitute the entire chat completion,
    ///     all <see cref="ReasoningContentUpdate"/> values across streaming updates must be combined.
    /// </remarks>
    public ChatMessageContent ReasoningContentUpdate => _reasoningContentUpdate ??= InternalChoiceDelta?.ReasoningContent ?? [];
