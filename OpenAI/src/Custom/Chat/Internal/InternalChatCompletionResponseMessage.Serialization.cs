...
internal partial class InternalChatCompletionResponseMessage
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void DeserializeReasoningContentValue(JsonProperty property, ref ChatMessageContent reasoningContent, ModelReaderWriterOptions options = null)
    {
