...
public partial class UserChatMessage : ChatMessage
{
    ...
    public UserChatMessage(IEnumerable<ChatMessageContentPart> contentParts)
        : this(content: new(contentParts), reasoningContent: null, role: ChatMessageRole.User, participantName: null, patch: default)
    {
    ...
    public UserChatMessage(string content)
        : this(content: new([content]), reasoningContent: null, role: ChatMessageRole.User, participantName: null, patch: default)
    {
