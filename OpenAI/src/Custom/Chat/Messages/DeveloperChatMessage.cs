...
public partial class DeveloperChatMessage : ChatMessage
{
    ...
    public DeveloperChatMessage(IEnumerable<ChatMessageContentPart> contentParts)
        : this(content: new ChatMessageContent(contentParts), reasoningContent: null, role: ChatMessageRole.Developer, participantName: null, patch: default)
    { }
    ...
    public DeveloperChatMessage(string content)
        : this(content: new ChatMessageContent([content]), reasoningContent: null, role: ChatMessageRole.Developer, participantName: null, patch: default)
    {
